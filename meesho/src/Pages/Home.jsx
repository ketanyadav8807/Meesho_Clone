...
const Home = () => {
  return (
    <div className="homeContainer">
      <div className="mainDiv">
        <div className="mainContentDiv">
          ...
          <div className="subTitle">
            <p className="mainContentSubTitle">
        ...
        <div className="mainImageDiv">
          <img
            src="https://images.meesho.com/images/marketing/1646054807245.jpg"
            alt=""
          />
        </div>
      </div>
      ...
      <FashionStorePoster />
      <HomeCarePoster />
      <div className="ResellerNewImg">
        <img src={require('../images/reseller.jpg')} alt="" />
      </div>
      <div className="RegisterNewImg">
